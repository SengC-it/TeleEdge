...
const computed = computeStrategyFreeze({root: APP_DIR, baseMainSha});
const generated = `// Generated by scripts/build-forward-validation-freeze.mjs.\n// Do not edit by hand. This file is excluded from its own fingerprint.\nexport const RUNTIME_V75_STRATEGY_SHA256 = '${computed.v75StrategySha256}';\nexport const RUNTIME_V8_STRATEGY_SHA256 = '${computed.v8StrategySha256}';\nexport const RUNTIME_PRODUCTION_SEMANTIC_SHA256 = '${computed.productionSemanticSha256}';\n`;
fs.mkdirSync(path.join(APP_DIR, 'supabase', 'functions', 'teleeg-worker'), {recursive: true});
fs.writeFileSync(path.join(APP_DIR, 'supabase', 'functions', 'teleeg-worker', 'forward-freeze.generated.mjs'), generated);
const manifest = {...computed, createdAt: new Date().toISOString()};
